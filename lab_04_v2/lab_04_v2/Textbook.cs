...
namespace lab_04_v2
{
    ...
    {
        internal string AreaOfResearch { get; set; }
        public Author author;

        internal Textbook(string NamePublisher, int CountOfCopies, int CountOfEmployees, string NameAuthor, string Gender, string AreaOfResearch)
            : base(NamePublisher, CountOfCopies, CountOfEmployees, NameAuthor, Gender)
        {
            this.AreaOfResearch = AreaOfResearch;
        }

        internal Textbook(Author author, string AreaOfResearch) : base(author.NamePublisher, author.CountOfCopies, author.CountOfEmployees, author.NameAuthor, author.Gender)
        {
            this.author = author;
            this.AreaOfResearch = AreaOfResearch;
        }
        ...
        public override string ToString()
        {
            return $"Название идателя: {NamePublisher} \n" +
                   ...
                   $"Облость обучения: {AreaOfResearch} \n";
        }
    }
}
